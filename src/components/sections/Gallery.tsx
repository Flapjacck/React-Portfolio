  ...
  return (
    ...
    >
      <RevealOnScroll>
        ...
        <div className="relative w-full max-w-6xl aspect-video sm:aspect-[4/3] md:aspect-[16/9] lg:aspect-[21/9] rounded-2xl overflow-hidden border border-white/10 shadow-[0_4px_15px_rgba(255,0,0,0.1)]">
          <img
        ...
        {/* Caption */}
        <p className="mt-6 text-red-300 text-sm sm:text-base text-center max-w-2xl px-4">

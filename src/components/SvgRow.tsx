  ...
  const SvgIcon = ({ href, svgPath, alt }: SvgIconProps) => (
    <a href={href} target="_blank" rel="noopener noreferrer" className="mx-2">
      <svg
        ...
        viewBox="0 0 50 50"
        fill="currentColor"
        className="w-15 h-15 text-blue-500 hover:text-blue-700 transition-colors"
        aria-label={alt}
      >
        <path d={svgPath} />
      </svg>
